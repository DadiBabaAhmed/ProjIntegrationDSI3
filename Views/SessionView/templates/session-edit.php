...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="p-4">
                <h2 class="page-header text-center">Modifier une session</h2>
                <form action="edit.php?id=<?php echo $session->Numero; ?>" method="post" class="mx-auto w-50"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1992" class="form-control" id="Annee" name="Annee"
                            value="<?php echo $session->Annee; ?>">
                        <span class="error-message" id="AnneeError"></span>
                    </div>
                    <div class="form-group">
                        <label for="Sem">Semestre</label>
                        <select class="form-control" id="Sem" name="Sem" value="<?php echo $session->Sem; ?>">
                    ...
                    <div class="form-group" style="display : none;">
                        ...
                        <select class="form-control" id="SemAb" name="SemAb" value="<?php echo $session->SemAb; ?>"
                            hidden>
                            <option value="2">2</option>
                            <option value="1">1</option>
                        </select>
