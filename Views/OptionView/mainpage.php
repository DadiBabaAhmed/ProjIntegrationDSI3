            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary open-modal-modifier" data-toggle="modal" data-target="#modifierModal" data-parametres='{"id": "<?php echo $row['Code_Option']; ?>", "optionName": "<?php echo $row['Option_Name']; ?>", "departement": "<?php echo $row['Departement']; ?>", "optionArab": "<?php echo $row['Option_AraB']; ?>"}'>
                                    Modifier
                                </button>
                            </td>
                            <td>
