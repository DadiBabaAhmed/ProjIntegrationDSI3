...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!preg_match("/^\d{8}$/", $_POST["NCIN"])) {
        ...
        header("Location: edit_etudiant.php?NCIN=<?php echo " . $ncin . "; ?>");
        exit();
    }
    ...
    try {
        ...
        echo "<div class='alert alert-danger'>Error: An error occurred; Please try again later.</div>
                <br><a href='edit_etudiant.php?NCIN=<?php echo " . $ncin . "; ?>'>Retour to Edit</a>";
    }
}
...
if (isset($_GET["NCIN"])) {
    ...
    $etudiantData = $etudiant->getEtudiant($ncin);
...
<body>
    <div class="container">
        ...
        if (isset($etudiantData) && !empty($etudiantData)) {
        ?>
            <form method="POST" action="edit_etudiant.php">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="Sexe" value="1" <?php if ($etudiantData["Sexe"] == 1) {
                                                                    echo "checked";
                                                                } ?>> &ensp; Male &emsp;
                    <input type="radio" name="Sexe" value="2" <?php if ($etudiantData["Sexe"] == 2) {
                                                                    echo "checked";
                                                                } ?>> &ensp; Female
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="AnnéeUnversitaire" class="form-control">
                        <?php foreach ($result as $row) : ?>
                            <option value="<?php echo $row["Annee"]; ?>" <?php if ($row["Annee"] == $etudiantData["AnnéeUnversitaire"]) {
                                                                                echo "selected";
                ...
                <div class="form-group">
                    ...
                    <select name="Semestre" class="form-control">
                        <option value="1" <?php if ($etudiantData["Semestre"] == 1) {
                                                echo "selected";
                                            } ?>>Semestre 1</option>
                        <option value="2" <?php if ($etudiantData["Semestre"] == 2) {
                                                echo "selected";
                                            } ?>>Semestre 2</option>
                    </select>
                </div>
        ...
        <?php
            ...
            echo "Etudiant not found. <a href='list_etudiants'>Retour</a>";
        }
        ?>
    </div>
