...
class Seance{
        ...
        public function getSeance($seance) {
            $sql = "SELECT * FROM seances WHERE SEANCE = ?";
            $stmt = $this->db->prepare($sql);
            $stmt->bind_param("s", $seance);
            $stmt->execute();
        ...
        public function addSeance() {
            ...
            if (isset($_POST['sauv_seance'])) {
                $seance = mysqli_real_escape_string($this->db, $_POST['SEANCE']);
                $horaire = mysqli_real_escape_string($this->db, $_POST['Horaire']);
                $hdeb = mysqli_real_escape_string($this->db, $_POST['HDeb']);
                $hfin = mysqli_real_escape_string($this->db, $_POST['HFin']);
        ...
        public function deleteSeance() {
            ...
            {
                $seance= mysqli_real_escape_string($this->db, $_POST['supprimer_seance']);
